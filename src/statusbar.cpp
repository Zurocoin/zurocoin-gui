...
//    , m_encryptionStatusIconLabel(new QLabel(this))
    ...
    , m_zurocoindConnectionLabel(new QLabel(this))
...
//    m_encryptionStatusIconLabel->setObjectName("m_encryptionStatusIconLabel");
    ...
    addPermanentWidget(m_zurocoindConnectionLabel);
...
void WalletStatusBar::setWalletModel(WalletModel* model)
{
    ...
    stateMapper_->addMapping(m_zurocoindConnectionLabel, WalletModel::COLUMN_LOWER_LEVEL_ERROR, "text");
